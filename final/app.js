...
var init = function init() {
  var hash = (0, _md2.default)(window.emailHash.email);
  var imgSize = 100;
  var genericImg = "mm";
  var avatarUrl = 'http://www.gravatar.com/avatar/' + hash + '?s=' + imgSize + '&d=' + genericImg;

  Array.from(document.querySelectorAll('.js-gravatar-hash')).forEach(function (el) {
...
var addEventListeners = function addEventListeners(elements) {
...
var toggleClass = function toggleClass(e) {
  ...
  // Display the content
  var content = e.target.parentElement.parentElement.parentElement.querySelector('.js-list-dropdown');
...
var _gravatar = __webpack_require__(1);

var _gravatar2 = _interopRequireDefault(_gravatar);

var _toollist = __webpack_require__(2);

var _toollist2 = _interopRequireDefault(_toollist);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_gravatar2.default.init();
_toollist2.default.init();
